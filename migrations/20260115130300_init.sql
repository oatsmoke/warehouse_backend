...
CREATE TABLE "public"."equipments" (
  ...
  CONSTRAINT "equipments_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Create index "idx_equipments_company" to table: "equipments"
...
CREATE TABLE "public"."locations" (
  ...
  CONSTRAINT "locations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Create index "idx_locations_user" to table: "locations"
