...
func (s *LocationService) List(ctx context.Context, toDepartmentID int64) (*dto.ListResponse[[]*model.Equipment], error) {
	list, total, err := s.locationRepository.List(ctx, toDepartmentID)
	if err != nil {
		return nil, err
	}
